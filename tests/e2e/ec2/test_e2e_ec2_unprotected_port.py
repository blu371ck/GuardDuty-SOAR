...
def test_ec2_unprotected_port_playbook_e2e(
    ...
    # Create the test event by combining valid_guardduty_event with port_probe_finding
    ...
    time.sleep(5)  # Give the playbook time to complete
    ...
    logger.info(
        f"Malicious IP {malicious_ip} was successfully blocked in NACL {nacl_id}."
    )
