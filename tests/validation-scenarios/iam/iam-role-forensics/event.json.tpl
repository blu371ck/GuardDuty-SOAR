{
    ...
    "detail": {
        ...
        "Description": "APIs commonly used in CredentialAccess tactics were invoked by user AssumedRole : ${role_name} under unusual circumstances.",
        "Resource": {
            "AccessKeyDetails": {
        ...
        "Severity": 5,
        "Title": "Role ${role_name} is anomalously invoking APIs.",
